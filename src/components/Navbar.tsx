...
const Navbar: React.FC = () => {
  return (
    <nav className="fixed top-0 left-0 w-full z-[100] px-6 py-8 md:px-12 backdrop-blur-md bg-[#05000a]/30">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex gap-8 text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 pointer-events-auto">
