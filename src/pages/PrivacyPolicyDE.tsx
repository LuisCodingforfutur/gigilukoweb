    ...
    return (
        <LegalPage title="Datenschutzerklärung" lastUpdated="6. Mai 2026">
            ...
            <section>
                ...
                <p>Wir nutzen den Standort Ihres Geräts für zwei verschiedene Zwecke:</p>
                <p><strong>(a) Vordergrund-Nutzung ("Beim Verwenden der App"):</strong> Wenn Sie die Discover-Funktion öffnen, zentriert sich die Karte auf Ihre aktuelle Position, um Venues in der Nähe anzuzeigen. Dies erfordert die Standard-Standortberechtigung und ist nur aktiv, während die App genutzt wird.</p>
                <p><strong>(b) Hintergrund-Nutzung ("Immer", optional, nur opt-in):</strong> Wenn Sie der App "Immer"-Standortzugriff gewähren, kann sie Ihre physische Nähe zu Bluetooth Low Energy (BLE) Beacons in Partner-Venues erkennen und so automatische Check-Ins ermöglichen — auch wenn die App geschlossen oder im Hintergrund ist. Diese Hintergrund-Verarbeitung wird ausschließlich durch Beacon-Näherungsereignisse ausgelöst; wir führen keine kontinuierliche Standortverfolgung im Hintergrund durch. Ohne diese Berechtigung sind automatische Check-Ins nicht verfügbar, manuelle Check-Ins funktionieren weiterhin uneingeschränkt.</p>
                <p>In beiden Fällen werden Ihre präzisen Standortkoordinaten ausschließlich lokal auf Ihrem Gerät verarbeitet und niemals an unsere Server übermittelt oder dort gespeichert. Es wird nur das resultierende Check-In-Ereignis (Venue-ID und Zeitstempel) in Ihrem Account erfasst. Rechtsgrundlage ist Ihre Einwilligung (Art. 6 Abs. 1 lit. a DSGVO). Sie können jederzeit von "Immer" auf "Beim Verwenden der App" herunterstufen oder den Standortzugriff vollständig widerrufen über die Datenschutzeinstellungen Ihres Geräts.</p>
